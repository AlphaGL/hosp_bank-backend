...
from .views import (
    ...
    # Dispense & Adjust (storekeeper)
    StockDispenseView,
    StockAdjustmentView,

    # Bulk Usage Recording (clinical staff)
    BulkUsageView,
    UsageHistoryView,
...
urlpatterns = [
    ...
    # ── Bulk Usage Recording (clinical staff — doctors/nurses) ─────────────
    path('record-usage/',   BulkUsageView.as_view(),    name='record-usage'),
    path('usage-history/',  UsageHistoryView.as_view(), name='usage-history'),

    # ── Internal JSON API ──────────────────────────────────────────────────
    path('api/item-stock/', ItemStockInfoView.as_view(), name='api-item-stock'),
    ...
    # ── Stock Movements (full ledger — read-only list + detail) ───────────
    ...
    # ── Storekeeper: Dispense & Adjustments ───────────────────────────────
